...
if(isset($_POST['submit'])){
  ...
  if($nameErr != "" OR $emailErr != "" OR $mobileErr !="" OR $genderErr !="" OR $passErr !="" OR $imageErr !="")
  {
    ...
    $sql="insert into `crud` (name,email,mobile,gender,password,image) values('$name', '$email', '$mobile', '$gender', '$pass','$image')";
    ...
    <div class="container my-5">
      ...
      <form method="post" >
        ...
        <div class="form-group">
          ...
          <span style="color: green;"><?php echo $validName; ?></span><br>
        </div>
        ...
        <div class="form-group">
          ...
          <span style="color: green;"><?php echo $validImage; ?></span>
        </div>
