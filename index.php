...
<?php
session_start();
$con =mysqli_connect("localhost", "admin", "Admin@123", "crudoperation");
...
$sql=mysqli_query($con, "SELECT * FROM crud WHERE email='$email' AND password='$pass'");
...
<nav class="navbar navbar-expand-lg bg-light" style="margin-left: 15px;">
   ...
   <center>
    <!-- <h1 style="background-color: white; color: red;">Contact App</h1><br> -->
    <h3>Login Page</h3>
</center>
